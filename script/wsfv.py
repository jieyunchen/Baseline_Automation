...
if __name__ == '__main__':
    ...
    if ((argc != 5) and (argc != 7)):
        print '******usage sample: wsfv.py -t mbxx -n 0(or 1)'
        exit (1)
    ...
    #WSFV begain here it contains 3 steps
    ...
    #Step2:Execute command "cat /dev/cpss0/ca/poke caWarmstartRecoveryOverride 4" on DS8K
    msg = "Executing command: date; cat 'cat /dev/cpss0/ca/poke caWarmstartRecoveryOverride 4'"
    cmd = "date; cat '/dev/cpss0/ca/poke caWarmstartRecoveryOverride 4'"  
